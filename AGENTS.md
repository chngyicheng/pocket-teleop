...
- ~~nav2 waypoint send (tap expanded minimap → `NavigateToPose` action goal; pause/resume; global path on minimap; E-STOP cancels; frame ENV-level)~~ **DONE + merged 2026-06-22; autonomous drive hardware-confirmed** (`feat/nav2-waypoint-*` merged to main; baseline 856/98/20/106): `docs/superpowers/plans/2026-06-21-nav2-waypoint-implementation.md`
