...
> - **+20 tests** (useWhepStream +3 defer/sync/no-leak; MissionTablet +6; MissionControl +11 across both layouts). All green. The 10 baseline reds (9 adversarial + 1 whep ICE-timer flake) unchanged; none in touched files.
>
