    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                'nav_action':             EnvironmentVariable('NAV_ACTION',             default_value='/navigate_to_pose'),
                'goal_frame':             EnvironmentVariable('NAV_GOAL_FRAME',         default_value='map'),
                'nav_path_topic':         EnvironmentVariable('NAV_PATH_TOPIC',         default_value='/plan'),
