    ...
    >
      ...
      <div
        ...
        style={{
          ...
          // +/- steppers) stays tappable where a joystick edge overlaps; still
          // below the toggle tab (z15). When collapsed the panel is translated
          // off-screen, so the raised z never blocks the video/joysticks.
          zIndex: 10,
        }}
      >
        {/* Title label */}
